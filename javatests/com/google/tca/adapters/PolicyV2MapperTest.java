...
public class PolicyV2MapperTest {
  ...
  public static class TestConversionFromTextProtoFile {
    ...
    public void toDomain_fromTextProto_mapsCorrectly() throws Exception {
      ...
      com.google.tca.policy.v2.Policies proto = builder.build();

      Policies domainPolicies = PolicyV2Mapper.toDomain(proto);
      ...
      assertThat(extensions.nameConstraints().get().permittedSubtrees().get(0))
          .isEqualTo(new UriNameConstraintInTrustDomain(".example1.org"));
      assertThat(extensions.nameConstraints().get().permittedSubtrees().get(1))
          .isEqualTo(new DnsNameConstraintInTrustDomain("dns.example2.org"));
    }
    ...
    public void toDomain_fromInvalidTextProto_throwsException() throws Exception {
      String textProto =
          readTestFile(
              "javatests/com/google/tca/adapters/resources/policy/v2/invalid_reference_values.textproto");
      ...
      assertThrows(InvalidPolicyException.class, () -> PolicyV2Mapper.toDomain(proto));
    }
  }
  ...
  public static class TestConversionFromManualProto {
    ...
    public void toDomain_policies_mapsCorrectly() {
      ...
      com.google.tca.policy.v2.ReferenceValues referenceValuesProto =
          com.google.tca.policy.v2.ReferenceValues.newBuilder()
              .setOakReferenceValues(oakRef)
              .build();

      com.google.tca.policy.v2.Policy policyProto =
          com.google.tca.policy.v2.Policy.newBuilder()
              .setPublisherId("pub1")
              .setWorkloadId("work1")
              .setOperatorDomain("trust.domain.com")
              .setOperatorRole("some-operator")
              .addReferenceValues(referenceValuesProto)
              .setCertificateAttributes(
                  com.google.tca.policy.v2.X509CertificateAttributes.newBuilder()
                      .setMaxCertificateValidity(
                          com.google.protobuf.Duration.newBuilder().setSeconds(3600).build())
                      .setX509Extensions(
                          com.google.tca.policy.v2.X509Extensions.newBuilder().build())
                      .setCertificateSubject(
                          com.google.tca.policy.v2.X500NameAttributes.newBuilder()
                              .putAttributes("2.5.4.3", "manual-subject")
                              .build())
                      .build())
              .build();

      com.google.tca.policy.v2.Policies policiesProto =
          com.google.tca.policy.v2.Policies.newBuilder()
              .putPolicies("test-policy", policyProto)
              .build();

      Policies domainPolicies = PolicyV2Mapper.toDomain(policiesProto);
      ...
      assertThat(domainPolicy.operatorDomain()).isEqualTo("trust.domain.com");
      assertThat(domainPolicy.operatorRole()).isEqualTo("some-operator");
    ...
    public void toDomain_policyWithFullExtensions_mapsCorrectly() {
      ...
      com.google.tca.policy.v2.Policy policyProto =
          com.google.tca.policy.v2.Policy.newBuilder()
              ...
              .setCertificateAttributes(
                  com.google.tca.policy.v2.X509CertificateAttributes.newBuilder()
                      .setX509Extensions(
                          com.google.tca.policy.v2.X509Extensions.newBuilder()
                              .setBasicConstraints(
                                  com.google.tca.policy.v2.BasicConstraints.newBuilder()
                                      .setCaCertificate(
                                          com.google.tca.policy.v2.CaCertificate.newBuilder()
                                              .setPathLenConstraint(2)
                                              .build())
                                      .build())
                              .setNameConstraints(
                                  com.google.tca.policy.v2.NameConstraints.newBuilder()
                                      .addPermittedSubtrees(
                                          com.google.tca.policy.v2.NameConstraint.newBuilder()
                                              .setUri(
                                                  com.google.tca.policy.v2.UriNameConstraint
                                                      .newBuilder()
                                                      .setSubdomainInTcaDomain(
                                      ...
                                      .addPermittedSubtrees(
                                          com.google.tca.policy.v2.NameConstraint.newBuilder()
                                              .setDns(
                                                  com.google.tca.policy.v2.DnsNameConstraint
                                                      .newBuilder()
                                                      .setSubdomainInTcaDomain("dns.example.com")
                                                      .build())
                                              .build())
                                      .build())
                              .build())
      ...
      Policy domainPolicy = PolicyV2Mapper.toDomain(policyProto);
      ...
      assertThat(extensions.nameConstraints()).isPresent();
      assertThat(extensions.nameConstraints().get().permittedSubtrees().get(0))
          .isEqualTo(new UriNameConstraintInTrustDomain("some.subdomain.example.com"));
      assertThat(extensions.nameConstraints().get().permittedSubtrees().get(1))
          .isEqualTo(new DnsNameConstraintInTrustDomain("dns.example.com"));
    }
                      ...
                      .setX509Extensions(
                          com.google.tca.policy.v2.X509Extensions.newBuilder()
                              .setBasicConstraints(
                                  com.google.tca.policy.v2.BasicConstraints.newBuilder()
                                      .setLeafCertificate(
                                          com.google.tca.policy.v2.LeafCertificate.newBuilder()
                                              .build()))
                              .build())
                      .setCertificateSubject(
                          com.google.tca.policy.v2.X500NameAttributes.newBuilder()
  ...
  public static class TestConversionErrors {
    ...
    private com.google.tca.policy.v2.Policies.Builder createValidPoliciesBuilder() {
      com.google.oak.attestation.v1.ReferenceValues oakRef =
          com.google.oak.attestation.v1.ReferenceValues.getDefaultInstance();
      com.google.tca.policy.v2.ReferenceValues referenceValuesProto =
          com.google.tca.policy.v2.ReferenceValues.newBuilder()
      ...
      return com.google.tca.policy.v2.Policies.newBuilder().putPolicies("test-policy", policyProto);
    }

    @Test
    public void toDomain_missingCertificateAttributes_throwsException() {
      com.google.tca.policy.v2.Policies.Builder builder = createValidPoliciesBuilder();
      com.google.tca.policy.v2.Policy.Builder policyBuilder =
          builder.getPoliciesOrThrow("test-policy").toBuilder();
      policyBuilder.clearCertificateAttributes();

      assertThrows(
          IllegalArgumentException.class, () -> PolicyV2Mapper.toDomain(policyBuilder.build()));
    }
    ...
    public void toDomain_unsupportedBasicConstraints_throwsException() {
      ...
      policyBuilder
          ...
          .setBasicConstraints(com.google.tca.policy.v2.BasicConstraints.newBuilder().build());
    ...
    public void toDomain_unsupportedReferenceValues_throwsException() {
      ...
      policyBuilder
          ...
          .addReferenceValues(com.google.tca.policy.v2.ReferenceValues.newBuilder().build());
